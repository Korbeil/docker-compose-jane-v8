...
class ServiceExtendsNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof ServiceExtends;
    }
    /**
    ...
    {
        return $type === ServiceExtends::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceExtends::class => true);
    }
}