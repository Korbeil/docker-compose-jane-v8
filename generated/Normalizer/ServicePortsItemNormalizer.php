...
class ServicePortsItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === ServicePortsItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServicePortsItem::class => true);
    }
}