...
class DeploymentNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof Deployment;
    }
    /**
    ...
    {
        return array(Deployment::class => true);
    }
}