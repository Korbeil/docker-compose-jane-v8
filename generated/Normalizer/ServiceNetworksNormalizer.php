...
class ServiceNetworksNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof ServiceNetworks;
    }
    /**
    ...
    {
        return $type === ServiceNetworks::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceNetworks::class => true);
    }
}