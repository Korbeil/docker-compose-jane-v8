...
class Service1
{
    public function __construct(
        public Development2|null $develop,
        public Deployment2|null $deploy,
        /** @var mixed|string[] */
        public mixed|array $annotations,
        public bool $attach,
        public string|ServiceBuild1 $build,
        public ServiceBlkioConfig1 $blkioConfig,
        /** @var string[] */
        public array $capAdd,
        /** @var string[] */
        ...
        /** @var string|ServiceConfigOrSecretItem5[] */
        ...
        public ServiceCredentialSpec1 $credentialSpec,
        /** @var string[]|mixed */
        ...
        /** @var string|string|EnvFileItem2[] */
        public string|array $envFile,
        /** @var mixed|string[] */
        public mixed|array $environment,
        /** @var string|float[] */
        public array $expose,
        public string|ServiceExtends1 $extends,
        /** @var string[] */
        ...
        /** @var string[] */
        public array $links,
        public ServiceLogging1 $logging,
        ...
        /** @var float|string|ServicePortsItem1[] */
        public array $ports,
        ...
        /** @var string|ServiceConfigOrSecretItem6[] */
        ...
        /** @var string|ServiceVolumesItem1[] */
