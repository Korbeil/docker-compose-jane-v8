...
class ServiceCredentialSpecNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceCredentialSpec $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceCredentialSpec;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var ServiceCredentialSpec $output */
    ...
    {
        return $type === ServiceCredentialSpec::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceCredentialSpec::class => true);
    }
}