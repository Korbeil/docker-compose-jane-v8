...
class ServiceDependsOn1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceDependsOn1 $object
     *
     * @return array
     */
    ...
    {
        return $type === ServiceDependsOn1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceDependsOn1::class => true);
    }
}