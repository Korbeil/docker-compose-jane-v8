...
class DeploymentRestartPolicyNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentRestartPolicy $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentRestartPolicy;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var DeploymentRestartPolicy $output */
    ...
    {
        return $type === DeploymentRestartPolicy::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentRestartPolicy::class => true);
    }
}