...
class ServiceConfigOrSecretItem4Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem4 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem4;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem4
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem4 $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem4::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem4::class => true);
    }
}