...
class DevicesItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof DevicesItem;
    }
    /**
    ...
    {
        return $type === DevicesItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DevicesItem::class => true);
    }
}