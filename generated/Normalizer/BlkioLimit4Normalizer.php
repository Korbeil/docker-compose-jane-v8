...
class BlkioLimit4Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioLimit4;
    }
    /**
    ...
    {
        return $type === BlkioLimit4::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioLimit4::class => true);
    }
}