...
class BlkioLimit8Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioLimit8;
    }
    /**
    ...
    {
        return $type === BlkioLimit8::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioLimit8::class => true);
    }
}