...
class DeploymentUpdateConfigNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentUpdateConfig $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentUpdateConfig;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var DeploymentUpdateConfig $output */
    ...
    {
        return $type === DeploymentUpdateConfig::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentUpdateConfig::class => true);
    }
}