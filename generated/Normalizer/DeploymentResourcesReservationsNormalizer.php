...
class DeploymentResourcesReservationsNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentResourcesReservations $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentResourcesReservations;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var DeploymentResourcesReservations $output */
    ...
    {
        return $type === DeploymentResourcesReservations::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentResourcesReservations::class => true);
    }
}