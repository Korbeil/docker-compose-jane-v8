...
class UlimitsNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof Ulimits;
    }
    /**
    ...
    {
        return $type === Ulimits::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(Ulimits::class => true);
    }
}