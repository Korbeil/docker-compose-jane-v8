...
class ComposeNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof Compose;
    }
    /**
    ...
    {
        return $type === Compose::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(Compose::class => true);
    }
}