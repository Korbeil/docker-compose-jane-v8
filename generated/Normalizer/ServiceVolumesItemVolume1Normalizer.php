...
class ServiceVolumesItemVolume1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItemVolume1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceVolumesItemVolume1;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceVolumesItemVolume1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceVolumesItemVolume1 $output */
    ...
    {
        return $type === ServiceVolumesItemVolume1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItemVolume1::class => true);
    }
}