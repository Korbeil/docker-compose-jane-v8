...
class ServiceBuild1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === ServiceBuild1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceBuild1::class => true);
    }
}