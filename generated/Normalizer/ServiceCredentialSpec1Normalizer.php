...
class ServiceCredentialSpec1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceCredentialSpec1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceCredentialSpec1;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceCredentialSpec1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceCredentialSpec1 $output */
    ...
    {
        return $type === ServiceCredentialSpec1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceCredentialSpec1::class => true);
    }
}