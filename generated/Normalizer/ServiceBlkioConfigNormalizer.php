...
class ServiceBlkioConfigNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceBlkioConfig $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceBlkioConfig;
    }
    /**
    ...
    {
        return $type === ServiceBlkioConfig::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceBlkioConfig::class => true);
    }
}