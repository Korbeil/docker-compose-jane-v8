...
class DeploymentResourcesNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentResources $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentResources;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var DeploymentResources $output */
    ...
    {
        return $type === DeploymentResources::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentResources::class => true);
    }
}