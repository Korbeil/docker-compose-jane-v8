...
class DeploymentRestartPolicy2Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentRestartPolicy2 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentRestartPolicy2;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentRestartPolicy2
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentRestartPolicy2 $output */
    ...
    {
        return $type === DeploymentRestartPolicy2::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentRestartPolicy2::class => true);
    }
}