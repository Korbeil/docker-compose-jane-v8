...
class ServiceVolumesItemVolumeNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItemVolume $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceVolumesItemVolume;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceVolumesItemVolume
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceVolumesItemVolume $output */
    ...
    {
        return $type === ServiceVolumesItemVolume::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItemVolume::class => true);
    }
}