...
class DevelopmentNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof Development;
    }
    /**
    ...
    {
        return $type === Development::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(Development::class => true);
    }
}