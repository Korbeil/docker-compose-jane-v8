...
class NetworkExternalNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof NetworkExternal;
    }
    /**
    ...
    {
        return $type === NetworkExternal::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(NetworkExternal::class => true);
    }
}