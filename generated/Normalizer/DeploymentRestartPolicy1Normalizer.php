...
class DeploymentRestartPolicy1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentRestartPolicy1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentRestartPolicy1;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentRestartPolicy1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentRestartPolicy1 $output */
    ...
    {
        return $type === DeploymentRestartPolicy1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentRestartPolicy1::class => true);
    }
}