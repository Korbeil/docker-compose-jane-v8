...
class GenericResourcesItemDiscreteResourceSpecNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param GenericResourcesItemDiscreteResourceSpec $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof GenericResourcesItemDiscreteResourceSpec;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var GenericResourcesItemDiscreteResourceSpec $output */
    ...
    {
        return $type === GenericResourcesItemDiscreteResourceSpec::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(GenericResourcesItemDiscreteResourceSpec::class => true);
    }
}