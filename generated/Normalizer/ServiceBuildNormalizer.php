...
class ServiceBuildNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof ServiceBuild;
    }
    /**
    ...
    {
        return $type === ServiceBuild::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceBuild::class => true);
    }
}