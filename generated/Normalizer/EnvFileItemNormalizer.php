...
class EnvFileItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof EnvFileItem;
    }
    /**
    ...
    {
        return $type === EnvFileItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(EnvFileItem::class => true);
    }
}