...
class VolumeExternalNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof VolumeExternal;
    }
    /**
    ...
    {
        return $type === VolumeExternal::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(VolumeExternal::class => true);
    }
}