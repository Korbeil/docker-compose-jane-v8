...
class ServiceConfigOrSecretItem5Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem5 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem5;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem5
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem5 $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem5::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem5::class => true);
    }
}