...
class BlkioLimit1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioLimit1;
    }
    /**
    ...
    {
        return $type === BlkioLimit1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioLimit1::class => true);
    }
}