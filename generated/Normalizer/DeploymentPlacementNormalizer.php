...
class DeploymentPlacementNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentPlacement $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentPlacement;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var DeploymentPlacement $output */
    ...
    {
        return $type === DeploymentPlacement::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentPlacement::class => true);
    }
}