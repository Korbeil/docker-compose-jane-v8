...
class NetworkIpamConfigItem1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param NetworkIpamConfigItem1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof NetworkIpamConfigItem1;
    }
    /**
     * @param array|object $data
     *
     * @return NetworkIpamConfigItem1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var NetworkIpamConfigItem1 $output */
    ...
    {
        return $type === NetworkIpamConfigItem1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(NetworkIpamConfigItem1::class => true);
    }
}