...
class ServiceDependsOnNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === ServiceDependsOn::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceDependsOn::class => true);
    }
}