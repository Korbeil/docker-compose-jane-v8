...
class DevelopmentWatchItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DevelopmentWatchItem $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DevelopmentWatchItem;
    }
    /**
     * @param array|object $data
     *
     * @return DevelopmentWatchItem
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DevelopmentWatchItem $output */
    ...
    {
        return $type === DevelopmentWatchItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DevelopmentWatchItem::class => true);
    }
}