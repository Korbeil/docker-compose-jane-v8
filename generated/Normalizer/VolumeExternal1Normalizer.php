...
class VolumeExternal1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === VolumeExternal1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(VolumeExternal1::class => true);
    }
}