...
class DeploymentUpdateConfig1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentUpdateConfig1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentUpdateConfig1;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentUpdateConfig1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentUpdateConfig1 $output */
    ...
    {
        return $type === DeploymentUpdateConfig1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentUpdateConfig1::class => true);
    }
}