...
class ServiceBlkioConfig1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceBlkioConfig1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceBlkioConfig1;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceBlkioConfig1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceBlkioConfig1 $output */
    ...
    {
        return $type === ServiceBlkioConfig1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceBlkioConfig1::class => true);
    }
}