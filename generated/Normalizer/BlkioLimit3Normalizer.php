...
class BlkioLimit3Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioLimit3;
    }
    /**
    ...
    {
        return $type === BlkioLimit3::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioLimit3::class => true);
    }
}