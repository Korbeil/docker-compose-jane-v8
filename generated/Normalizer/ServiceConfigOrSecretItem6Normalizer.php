...
class ServiceConfigOrSecretItem6Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem6 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem6;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem6
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem6 $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem6::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem6::class => true);
    }
}