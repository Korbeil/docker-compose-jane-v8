...
class ServiceVolumesItemBind1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItemBind1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceVolumesItemBind1;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceVolumesItemBind1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceVolumesItemBind1 $output */
    ...
    {
        return $type === ServiceVolumesItemBind1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItemBind1::class => true);
    }
}