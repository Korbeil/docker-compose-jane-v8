...
class NetworkIpamConfigItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param NetworkIpamConfigItem $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof NetworkIpamConfigItem;
    }
    /**
     * @param array|object $data
     *
     * @return NetworkIpamConfigItem
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var NetworkIpamConfigItem $output */
    ...
    {
        return $type === NetworkIpamConfigItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(NetworkIpamConfigItem::class => true);
    }
}