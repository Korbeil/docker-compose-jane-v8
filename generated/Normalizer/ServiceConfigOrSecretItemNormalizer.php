...
class ServiceConfigOrSecretItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem::class => true);
    }
}