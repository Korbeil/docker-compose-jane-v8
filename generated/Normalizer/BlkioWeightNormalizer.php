...
class BlkioWeightNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioWeight;
    }
    /**
    ...
    {
        return $type === BlkioWeight::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioWeight::class => true);
    }
}