...
class DeploymentPlacementPreferencesItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentPlacementPreferencesItem $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentPlacementPreferencesItem;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentPlacementPreferencesItem
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentPlacementPreferencesItem $output */
    ...
    {
        return $type === DeploymentPlacementPreferencesItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentPlacementPreferencesItem::class => true);
    }
}