...
class ServiceVolumesItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItem $object
     *
     * @return array
     */
    ...
    {
        return $type === ServiceVolumesItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItem::class => true);
    }
}