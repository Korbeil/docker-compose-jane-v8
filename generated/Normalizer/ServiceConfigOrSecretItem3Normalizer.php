...
class ServiceConfigOrSecretItem3Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem3 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem3;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem3
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem3 $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem3::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem3::class => true);
    }
}