...
class SecretExternalNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof SecretExternal;
    }
    /**
    ...
    {
        return $type === SecretExternal::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(SecretExternal::class => true);
    }
}