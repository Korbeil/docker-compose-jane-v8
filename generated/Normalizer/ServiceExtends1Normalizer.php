...
class ServiceExtends1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === ServiceExtends1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceExtends1::class => true);
    }
}