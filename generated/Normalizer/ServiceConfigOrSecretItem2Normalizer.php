...
class ServiceConfigOrSecretItem2Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceConfigOrSecretItem2 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceConfigOrSecretItem2;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceConfigOrSecretItem2
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceConfigOrSecretItem2 $output */
    ...
    {
        return $type === ServiceConfigOrSecretItem2::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceConfigOrSecretItem2::class => true);
    }
}