...
class Deployment1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof Deployment1;
    }
    /**
    ...
    {
        return $type === Deployment1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(Deployment1::class => true);
    }
}