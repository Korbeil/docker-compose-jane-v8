...
class DeploymentRollbackConfig1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentRollbackConfig1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentRollbackConfig1;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentRollbackConfig1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentRollbackConfig1 $output */
    ...
    {
        return $type === DeploymentRollbackConfig1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentRollbackConfig1::class => true);
    }
}