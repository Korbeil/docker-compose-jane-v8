...
class _IncludeNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof _Include;
    }
    /**
    ...
    {
        return $type === _Include::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(_Include::class => true);
    }
}