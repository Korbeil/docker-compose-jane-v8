...
class ServiceVolumesItemTmpfs1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItemTmpfs1 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceVolumesItemTmpfs1;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceVolumesItemTmpfs1
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceVolumesItemTmpfs1 $output */
    ...
    {
        return $type === ServiceVolumesItemTmpfs1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItemTmpfs1::class => true);
    }
}