...
class ServiceVolumesItemBindNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param ServiceVolumesItemBind $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof ServiceVolumesItemBind;
    }
    /**
     * @param array|object $data
     *
     * @return ServiceVolumesItemBind
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var ServiceVolumesItemBind $output */
    ...
    {
        return $type === ServiceVolumesItemBind::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ServiceVolumesItemBind::class => true);
    }
}