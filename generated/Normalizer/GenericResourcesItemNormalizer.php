...
class GenericResourcesItemNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param GenericResourcesItem $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof GenericResourcesItem;
    }
    /**
    ...
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        ...
        $class = $type;
        /** @var GenericResourcesItem $output */
    ...
    {
        return $type === GenericResourcesItem::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(GenericResourcesItem::class => true);
    }
}