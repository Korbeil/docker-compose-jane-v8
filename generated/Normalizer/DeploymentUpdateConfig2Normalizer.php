...
class DeploymentUpdateConfig2Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    /**
     * @param DeploymentUpdateConfig2 $object
     *
     * @return array
     */
    ...
    {
        return $data instanceof DeploymentUpdateConfig2;
    }
    /**
     * @param array|object $data
     *
     * @return DeploymentUpdateConfig2
     */
    function denormalize(mixed $data, string $type, string $format = null, array $context = array()) : mixed
    {
        /** @var class-string $class */
        $class = $type;
        /** @var DeploymentUpdateConfig2 $output */
    ...
    {
        return $type === DeploymentUpdateConfig2::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(DeploymentUpdateConfig2::class => true);
    }
}