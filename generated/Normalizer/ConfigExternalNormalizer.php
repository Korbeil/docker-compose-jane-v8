...
class ConfigExternalNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof ConfigExternal;
    }
    /**
    ...
    {
        return $type === ConfigExternal::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(ConfigExternal::class => true);
    }
}