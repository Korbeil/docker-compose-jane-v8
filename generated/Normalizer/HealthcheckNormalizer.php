...
class HealthcheckNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $type === Healthcheck::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(Healthcheck::class => true);
    }
}