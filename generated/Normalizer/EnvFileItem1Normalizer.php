...
class EnvFileItem1Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof EnvFileItem1;
    }
    /**
    ...
    {
        return $type === EnvFileItem1::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(EnvFileItem1::class => true);
    }
}