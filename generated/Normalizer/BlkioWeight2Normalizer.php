...
class BlkioWeight2Normalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        return $data instanceof BlkioWeight2;
    }
    /**
    ...
    {
        return $type === BlkioWeight2::class;
    }
    /** @return array<class-string, bool> */
    function getSupportedTypes(?string $format) : array
    {
        return array(BlkioWeight2::class => true);
    }
}